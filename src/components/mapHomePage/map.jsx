    ...
    <div className="flex flex-col md:flex-row justify-center items-center my-5 mx-auto">
      ...
      <div className="md:w-5/12 md:mx-2">
        ...
        <div className="text-center mt-3">
          <p className="text-lg">
            To schedule an appointment, you can reach us by phone, WhatsApp, or fill out the form in our <a href="#contacto" className="text-blueMedium">Contact</a> section. <br /><br />We appreciate you choosing Harmony Wellness & Spa!
          </p>
        </div>
      </div>
